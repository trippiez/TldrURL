...
Файл `TldrURL.postman_collection.json` содержит postman-коллекцию - набор заранее подготовленных запросов для проверки работы API.
...
Загрузите файл `TldrURL.postman_collection.json` в Postman.
